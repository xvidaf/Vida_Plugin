...
public class CreateActionDialog extends TitleAreaDialog{
	private Text objectName;
	private Boolean created;
	private UMLAction createdObject;
    ...
    public void create() {
        super.create();
        setTitle("Create a New Action");
        setMessage("You can specify the action attributes below.\nConfirm the creation with the create button.", IMessageProvider.INFORMATION);
    }
    ...
    private void createProjectName(Composite container) {
        ...
        lbtProjectName.setText("Action Name");
    ...
    protected void okPressed() {
    	...
    	if(objectName.getText() != "") {
        	if(RootManager.getInstance().getAllInstances().containsKey(objectName.getText())) {
        		...
        		this.createdObject = new UMLAction(objectName.getText());
            	this.created = true;
                super.okPressed();	
        	}
    	}
	...
	public UMLAction getCreatedElement() {
