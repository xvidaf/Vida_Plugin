...
public class CreateActivityDiagramDialog extends TitleAreaDialog{
	private Text projectName;
	private Boolean created;
	private ActivityDiagram createdAD;
    
    public CreateActivityDiagramDialog() {
    ...
    public void create() {
        super.create();
        setTitle("Activity Diagram Details");
        setMessage("You can specify the activity diagram attributes below.\nConfirm the creation with the create button.", IMessageProvider.INFORMATION);
    }
    ...
    protected void configureShell(Shell newShell)
    {
      ...
      newShell.setText("Activity Diagram Detail");
    }
    ...
    private void createProjectName(Composite container) {
        ...
        lbtProjectName.setText("Activity Diagram Name");
    ...
    protected void okPressed() {
    	...
    	if(projectName.getText() != "") {
        	if(RootManager.getInstance().getAllInstances().containsKey(projectName.getText())) {
        		...
        		this.createdAD = new ActivityDiagram(projectName.getText());
            	this.created = true;
                super.okPressed();	
        	}
    	}
